...
import { FetchStatus, TCalculateBidParams, TCalculatedBid, TDeleteParams, TPlaceBidParams, TSignature, TStartAuctionParams, TWithdrawBid, TWithdrawBidsParams, TWithdrawChooseBidsParams } from './types';
...
export const getWithdrawBids = (body: TWithdrawBidsParams) => get<TWithdrawBid[]>(`${endpoint}/withdraw_bids`, { ...defaultParams, params: body });
