...
const ExtrinsicDetail: FC = () => {
  ...
  return (
    <>
      {isExtrinsicFetching ? <LoadingComponent /> : <>
        ...
        <div className={'grid-container container-with-border margin-top'}>
          ...
          <div className={'grid-item_col11'}>
            {Number(extrinsics?.view_extrinsic[0]?.amount) || 0} QTZ
          </div>
          <div className={'grid-item_col1 text_grey margin-top '}>Fee</div>
          <div className={'grid-item_col11 margin-top '}>{extrinsics?.view_extrinsic[0]?.fee} QTZ</div>
        </div>
